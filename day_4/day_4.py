...
def scan_all_directions(word_matrix, line_index, col_index, length):
    index_matches = 0
    index_matches += scan_horizontally(word_matrix, line_index, col_index, length)
    index_matches += scan_vertically(word_matrix, line_index, col_index, length)
    index_matches += scan_diagonally(word_matrix, line_index, col_index, length)
    return index_matches


def scan_horizontally(word_matrix, line_index, col_index, length):
    index_matches = 0
    ...
    index_matches += validate_word(word, "XMAS")
    index_matches += validate_word(reversed_word, "XMAS")

    return index_matches


def scan_vertically(word_matrix, line_index, col_index, length):
    index_matches = 0
...
def scan_diagonally(word_matrix, line_index, col_index, length):
    index_matches = 0
    ...
    index_matches += validate_word(forward_upward_word, "XMAS")
    index_matches += validate_word(forward_downward_word, "XMAS")
    index_matches += validate_word(backward_upward_word, "XMAS")
    index_matches += validate_word(backward_downward_word, "XMAS")
...
results_part_1 = scan_matrix_part1(word_matrix, "XMAS")
